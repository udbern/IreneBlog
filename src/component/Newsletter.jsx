      ...
      <section className=' py-10 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500  '>
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 gap-8 text-center md:text-left md:grid-cols-2 md:gap-16 items-center ">
          <div>
            ...
            <p className=' text-[#f2f1ed]'>Receive the latest updates, No spam, unsubscribe anytime!</p>
          </div>
          <div>
            <form>
              <input type="email" name="email" id="email" placeholder='example@gmail.com' required className='w-full py-2 px-4 rounded shadow mb-4  bg-[#f2f1ed]   text-gray-800 tracking-wide placeholder-gray-500 '/>
