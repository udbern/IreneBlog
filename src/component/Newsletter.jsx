...
export default function Newsletter() {
  return (
    <>
      <section className=' py-10 bg-gradient-to-r from-indigo-600  to-indigo-800 '>
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 gap-8 text-center md:text-left md:grid-cols-2 md:gap-16 items-center ">
          ...
          <div>
            <form>
              ...
              <button className='bg-[#d6eafa] py-2 px-8 rounded shadow test-gray-800 tracking-wide w-full hover:opacity-75 transition-all duration-200 md:w-auto   ' type="submit">Subscribe</button>
            </form>
          </div>
        </div>
      </section>
