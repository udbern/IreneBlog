...
export default function Blog() {
  ...
  return (
    <>
      ...
      <h1 className='text-4xl lg:text-5xl mb-6 capitalize mt-5 '>all blog post</h1>
    </div>
      <section className=' grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 px-5 mt-20 max-w-7xl mx-auto  '>
        {stories.map((story) => (
